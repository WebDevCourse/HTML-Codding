let videoAsideSource = document.getElementById("videoAsideTemplate").innerHTML;
let videoAsidetemplate = Handlebars.compile(videoAsideSource);
...
let videoAsideoutput = videoAsidetemplate(videoData);
document.querySelector(".aside-layout-video").innerHTML = videoAsideoutput;